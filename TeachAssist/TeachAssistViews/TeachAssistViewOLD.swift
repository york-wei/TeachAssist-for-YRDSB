...
struct TeachAssistViewOLD: View {
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            //.navigationTitle(self.userDataVM.studentID)
...
//                        .font(.title)
//                        .foregroundColor(Color("PrimaryTextColor").opacity(0))
//                }
//
//            }
...
public func get(type: String) -> CGFloat {
    ...
    //    iPhone 12 Mini
    case .iPhone12Mini: topPadding = 80.0; sidePadding = 37; cellHeight = 95.0; titleFont = 32.0; regularFont = 14.0; smallFont = 11; tabHeight = 55; loginTopPadding = 135.0; menuTopBottomPadding = 120.0; menuButtonPadding = 15.0
