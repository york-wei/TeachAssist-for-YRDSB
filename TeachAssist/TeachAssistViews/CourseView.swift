...
//                        
//                        if !editing {
//                            Text(self.userDataVM.courses[courseIndex].parsedAverage < 0 ? "N/A" : String(format: "%.1f%%", Double(self.userDataVM.courses[courseIndex].parsedAverage)))
...
//                        }
//                        else {
//                            Text(self.userDataVM.editCourse.parsedAverage < 0 ? "N/A" : String(format: "%.1f%%", Double(self.userDataVM.editCourse.parsedAverage)))
//                                .font(.system(size: get(type: "title"), weight: .light))
//                                .foregroundColor(Color("PrimaryTextColor"))
//                                .offset(x: 0, y: 4)
//                                .animation(.none)
...
//                ProgressBarView(percentage: !editing ? self.userDataVM.courses[courseIndex].parsedAverage : self.userDataVM.editCourse.parsedAverage)
//                        .offset(x: 0, y: -10)
//                        .padding(.bottom, 20)
                VStack {
                    HStack {
                    ...
                    RingView(percentage: !editing ? self.userDataVM.courses[courseIndex].parsedAverage : self.userDataVM.editCourse.parsedAverage)
                    .padding(.top, 20)
                    .padding(.bottom, 15)
                    Text(!editing ? "Course Average" : "Predicted Course Average")
                    .font(.system(size: get(type: "small"), weight: .regular))
