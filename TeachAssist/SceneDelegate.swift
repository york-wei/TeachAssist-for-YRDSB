...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if !UserDefaults.standard.bool(forKey: "loggedOutForUpdate3.0") && UserDefaults.standard.bool(forKey: "isLoggedIn") {
            UserDefaults.standard.set(true, forKey: "loggedOutForUpdate3.0")
        ...
        if !UserDefaults.standard.bool(forKey: "resetCoursesForUpdate3.1.0") {
            UserDefaults.standard.removeObject(forKey: "savedCourses")
            UserDefaults.standard.set(true, forKey: "resetCoursesForUpdate3.1.0")
        }
        ...
        if let windowScene = scene as? UIWindowScene {
            ...
            window.rootViewController = UIHostingController(rootView: contentView.environmentObject(userDataViewModel))
            self.window = window
